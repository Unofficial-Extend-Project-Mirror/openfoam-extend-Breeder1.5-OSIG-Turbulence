...
//         This definition has no internal mesh expansion.
...
//Geometry
m4_define(rIn, 25.39) //Small radius ok
m4_define(rOut, 49.25) //Large radius ok
...
//Radial grading:
m4_define(rGrading1, 4)
m4_define(rGrading2, 0.1)
m4_define(rGrading3, 10)
...
(
    ...
    simpleGrading (rGrading3 1 zGradingCD)
    // block10 - positive y O-grid block 3rd belt
    ...
    simpleGrading (rGrading3 1 zGradingDE)
    // block10 - positive y O-grid block 3rd belt
    ...
    simpleGrading (rGrading3 1 zGradingEF)
    // block10 - positive y O-grid block 3rd belt
    ...
    simpleGrading (rGrading1 1 zGradingFG)
    // block1 - positive y O-grid block 1st belt
    ...
    simpleGrading (rGrading3 1 zGradingFG)
    // block10 - positive y O-grid block 3rd belt
    ...
    simpleGrading (rGrading1 1 zGradingGH)
    // block1 - positive y O-grid block 1st belt
    ...
    simpleGrading (rGrading3 1 zGradingGH)
    // block10 - positive y O-grid block 3rd belt
